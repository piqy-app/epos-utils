...
import { page070 } from '../pages/page-070.js'
...
export const indicCodepages = [page066, page067, page068, page069, page070, page071, page072, page073, page074, page075, page082] as const
